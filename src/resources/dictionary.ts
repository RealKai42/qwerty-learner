...
export const dictionaries: Dictionary[] = [
  ...
  {
    id: '4000 Essential English Words01',
    name: 'Essential Words',
    description: '4000 Essential English Words meaning',
    category: 'English-English',
    url: './dicts/English-English/4000 Essential English Words-meaning.json',
    length: 3600,
  },
  {
    id: '4000 Essential English Words02',
    name: 'Essential Words',
    description: '4000 Essential English Words sentence',
    category: 'English-English',
    url: './dicts/English-English/4000 Essential English Words-sentence.json',
    length: 3600,
  },
  {
    id: '4000 Essential English Words03',
    name: 'Essential Words',
    description: '4000 Essential English Words Words-letters completion',
    category: 'English-English',
    url: './dicts/English-English/4000 Essential English Words-letters completion.json',
    length: 3600,
  },
  {
    id: '4000 Essential English Words04',
    name: 'Essential Words',
    description: 'guess words by radom order in 4000 Essential English',
    category: 'English-English',
    url: './dicts/English-English/4000 Essential English Words-radom order.json',
    length: 3600,
  },
  {
    id: '4000 Essential English Words05',
    name: 'Essential Words',
    description: '4000 Essential English Words-sentence completion',
    category: 'English-English',
    url: './dicts/English-English/4000 Essential English Words-sentence completion.json',
    length: 3600,
  },
  {
    id: 'pharsal verbs01',
    name: 'pharsal verbs meaning',
    description: 'basic pharsal verbs meaning',
    category: 'English-English',
    url: './dicts/English-English/phrasal verbs-meaning.json',
    length: 1550,
  },
  {
    id: 'pharsal verbs02',
    name: 'pharsal verbs example',
    description: 'basic pharsal verbs example',
    category: 'English-English',
    url: './dicts/English-English/phrasal verbs-example.json',
    length: 1550,
  },
  {
    id: 'verbs form01',
    name: 'verbs form',
    description: 'basic verbs form',
    category: 'English-English',
    url: './dicts/English-English/verbsform.json',
    length: 286,
  },
  {
    id: 'SAT01',
    name: 'SAT',
    description: 'Words use in SAT',
    category: 'English-English',
    url: './dicts/English-English/SAT.json',
    length: 2681,
  },
  {
    id: 'japanese01',
    ...
    url: './dicts/English-Japanese/JapVocabList.N1.json',
    length: 3477,
  },
  {
    id: 'japanese02',
    ...
    category: 'English-Japanese',
    url: './dicts/English-Japanese/JapVocabList.N2.json',
    length: 1836,
  },
  {
    id: 'japanese03',
    ...
    category: 'English-Japanese',
    url: './dicts/English-Japanese/JapVocabList.N3.json',
    length: 1830,
  },
  {
    id: 'japanese04',
    ...
    category: 'English-Japanese',
    url: './dicts/English-Japanese/JapVocabList.N4.json',
    length: 635,
  },
  {
    id: 'japanese05',
    ...
    category: 'English-Japanese',
    url: './dicts/English-Japanese/JapVocabList.N5.json',
    length: 670,
  },
  {
    id: 'French01',
