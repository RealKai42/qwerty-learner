...
export const dictionaries: Dictionary[] = [
  ...
  { id: 'ieltsWang3', name: '雅思王C3', description: '雅思王-雅思听力特别名词语料库', category: '英语学习', url: './dicts/IELTS_WANG_3.json', length: 1135 },
  { id: 'ieltsWang4', name: '雅思王C4', description: '雅思王-雅思听力形容词副词语料库', category: '英语学习', url: './dicts/IELTS_WANG_4.json', length: 346 },
  { id: 'ieltsWang5', name: '雅思王C5', description: '雅思王-吞音连读混合训练语料库', category: '英语学习', url: './dicts/IELTS_WANG_5.json', length: 1569 },
  { id: 'ieltsWang11', name: '雅思王C11', description: '雅思王-综合测试', category: '英语学习', url: './dicts/IELTS_WANG_11.json', length: 1737 },
