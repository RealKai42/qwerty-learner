...
export const LANG_PRON_MAP: LanguagePronunciationMap = {
  en: {
    ...
    pronunciation: [
      {
        name: 'pronunciation.american',
        pron: 'us',
      },
      {
        name: 'pronunciation.british',
        pron: 'uk',
      },
    ],
  },
