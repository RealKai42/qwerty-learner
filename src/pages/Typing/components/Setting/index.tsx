              ...
              >
                <Dialog.Panel className="flex w-200 flex-col overflow-hidden rounded-2xl bg-white p-0 shadow-xl dark:bg-gray-800">
                  <div className="relative flex h-22 items-end justify-between rounded-t-lg border-b border-neutral-100 bg-stone-50 px-6 py-3 dark:border-neutral-700 dark:bg-gray-900">
                    <span className="text-3xl font-bold text-gray-600">{t('settings.title')}</span>
                    <button type="button" onClick={() => setIsOpen(false)} title={t('settings.close_dialog')}>
                  ...
                  <Tab.Group vertical>
                    <div className="flex h-120 w-full ">
                      <Tab.List className="flex h-full w-64 flex-col items-start space-y-3  border-r border-neutral-100 bg-stone-50 px-6 py-3 dark:border-transparent dark:bg-gray-900">
                        <Tab
                          className={({ selected }) =>
                            classNames(
                        ...
                        >
                          ...
                          <span className="text-neutral-500 dark:text-neutral-300 ">{t('settings.tabs.sound')}</span>
                        </Tab>
                        <Tab
                          className={({ selected }) =>
                            classNames(
                        ...
                        >
                          ...
                          <span className="text-neutral-500 dark:text-neutral-300">{t('settings.tabs.advanced')}</span>
                        </Tab>
                        <Tab
                          className={({ selected }) =>
                            classNames(
                        ...
                        >
                          ...
                          <span className="text-neutral-500 dark:text-neutral-300">{t('settings.tabs.view')}</span>
                        </Tab>
                        <Tab
                          className={({ selected }) =>
                            classNames(
                        ...
                        >
                          ...
                          <span className="text-neutral-500 dark:text-neutral-300">{t('settings.tabs.data')}</span>
                        </Tab>
                      </Tab.List>
