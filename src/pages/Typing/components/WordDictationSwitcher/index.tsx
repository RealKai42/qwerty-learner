...
const defaultWordDictationTypeList: { name: string; type: WordDictationType }[] = [
  {
    name: '全部隐藏',
    type: 'hideAll',
  },
...
const romajiWordDictationTypeList: { name: string; type: WordDictationType }[] = [
  {
    name: '隐藏罗马字',
    type: 'hideAll',
  },
...
export default function WordDictationSwitcher() {
  ...
  const wordDictationTypeList =
    useAtomValue(currentDictInfoAtom).language === 'romaji' ? romajiWordDictationTypeList : defaultWordDictationTypeList
  ...
  }, [wordDictationConfig.type, wordDictationTypeList])
