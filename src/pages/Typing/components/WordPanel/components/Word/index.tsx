...
export default function WordComponent({ word, onFinish }: { word: Word; onFinish: () => void }) {
  ...
  return (
    <>
      ...
      >
        {['romaji', 'hapin', 'teochew'].includes(currentLanguage) && word.notation && <Notation notation={word.notation} />}
        <div
        ...
        >
          ...
          {pronunciationIsOpen && word && ((word.phone !== undefined && word.phone.trim() !== '') || word.phone === undefined) && (
