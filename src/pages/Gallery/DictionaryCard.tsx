...
import HeroiconsCheckCircle from '~icons/heroicons/check-circle-solid'
  ...
  return (
    ...
    >
      ...
      {currentDictId === dictionary.id ? (
        <HeroiconsCheckCircle className="absolute -bottom-4 -right-4 h-18 w-18 text-6xl text-green-500 opacity-60 dark:text-green-300" />
      ) : null}
    </button>
  )
}
