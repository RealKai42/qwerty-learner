...
const DataTag: React.FC<DataTagProps> = ({ icon, name, data }) => {
  ...
  return (
    <div className="g flex h-10 w-52 flex-1 select-none items-center justify-between rounded-md border-gray-400 bg-gray-100 px-3 py-5 shadow dark:border-gray-600 dark:bg-gray-800">
